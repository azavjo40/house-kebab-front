    ...
    <div className="w-full bg-slate-200 h-[90vh] p-3 md:p-10">
      <div className="w-full h-full bg-white rounded-xl flex flex-col-reverse md:flex-row">
        <div className="w-full md:w-[60%] h-full">
          <iframe
            className="w-full h-full bg-white md:rounded-l-xl rounded-t-xl"
        ...
        <div className="h-full w-full">
          <h1 className="mb-2 text-lg font-semibold text-gray-900 dark:text-white text-center mt-6">
            Skontaktuj się z nami
          </h1>
          <div className="flex h-full w-full justify-around pt-10">
            <div>
              <h1 className="mb-2 text-lg font-semibold text-gray-900 dark:text-white">House Kebab Pizza</h1>
            ...
            <div>
              <h1 className="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Colophon</h1>
              <ul className="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
